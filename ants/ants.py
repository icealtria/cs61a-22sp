    ...
    def nearest_bee(self):
        ...
        while curr_place:
            if self.lower_bound <= distance <= self.upper_bound:
                if curr_place.bees and not curr_place.is_hive:
...
class FireAnt(Ant):
    ...
    def reduce_health(self, amount):
        ...
        if self.health > amount:
            ...
            burn_bees(self.damage)
            super().reduce_health(amount)
        # END Problem 5              # How many bees are there?
# BEGIN Problem 6
# The WallAnt class
class WallAnt(Ant):
    name = "Wall"
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        while place and not place.is_hive:
            if place.ant and distance != 0:
                insects_list = place.bees + [place.ant]
            else:
                insects_list = place.bees
